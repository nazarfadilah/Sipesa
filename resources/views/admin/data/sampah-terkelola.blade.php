    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="mb-3 d-flex justify-content-between align-items-center">
                <div>
                    <a href="{{ route('admin.data.sampah-terkelola.create') }}" class="btn btn-primary btn-sm">
                ...
                <table class="table table-bordered table-striped" id="sampahTerkelolaTable">
                    <thead class="bg-primary text-white">
                        <tr>
                            ...
                            <th class="text-center sortable" width="15%">User</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{ \Carbon\Carbon::parse($sampah->tgl_kelola)->format('d-m-Y') }}</td>
                            <td class="text-center">
                                <a href="{{ route('admin.data.sampah-terkelola.show', $sampah->id) }}" class="btn btn-sm btn-primary">
