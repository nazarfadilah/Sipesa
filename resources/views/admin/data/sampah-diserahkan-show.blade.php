    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="p-4 rounded-top" style="background-color: #1E3F8C;">
                <h4 class="text-white mb-0">Detail Sampah Diserahkan</h4>
            </div>
            <div class="bg-white p-4 rounded-bottom shadow">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6 pb-3 border-bottom">
                        <label class="form-label fw-bold text-muted">Tanggal Diserahkan</label>
                        <p class="mb-0 fs-5">
                ...
                <div class="row mb-3">
                    <div class="col-md-6 pb-3 border-bottom">
                        ...
                        <p class="mb-0 fs-5">
                            {{ $sampah->tujuanSampah->nama_tujuan ?? '-' }}
                        </p>
                    </div>
                    <div class="col-md-6 pb-3 border-bottom">
                        ...
                        <p class="mb-2">
                            @if($sampah->foto_diserahkan)
                                <a href="{{ asset('storage/' . $sampah->foto_diserahkan) }}" target="_blank" class="btn btn-sm btn-light">
                        ...
                        @if($sampah->foto_diserahkan)
                        <div>
                            <img src="{{ asset('storage/' . $sampah->foto_diserahkan) }}" alt="Foto Sampah" style="max-width: 300px; border-radius: 4px;">
                        </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-start gap-2 mt-4">
                    ...
                    <a href="{{ route('admin.data.sampah-diserahkan.edit', $sampah->id) }}" class="btn btn-warning">
