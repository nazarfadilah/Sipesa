...
@section('title', 'Tambah Data Sampah Terkelola')
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="bg-primary p-4 rounded-top">
                <h4 class="text-white mb-0">Tambah Data Sampah Terkelola</h4>
            </div>
            <div class="bg-white p-4 rounded-bottom shadow">
                ...
                <form action="{{ route('admin.data.sampah-terkelola.store') }}" method="POST" enctype="multipart/form-data" id="formSampah">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" id="tgl" name="tgl" class="form-control @error('tgl') is-invalid @enderror" value="{{ old('tgl', date('Y-m-d')) }}" required>
                                @error('tgl')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
