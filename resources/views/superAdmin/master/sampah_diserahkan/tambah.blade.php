            ...
            <form action="{{ route('superadmin.master.sampah-diserahkan.store') }}" method="POST" id="sampahDiserahkanForm">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control @error('tgl_diserahkan') is-invalid @enderror" id="tgl_diserahkan" name="tgl_diserahkan" value="{{ old('tgl_diserahkan', date('Y-m-d')) }}" required>
                        @error('tgl')
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('id_tujuan') is-invalid @enderror" id="id_tujuan" name="id_tujuan" required>
                            ...
                            @foreach($tujuanSampahs as $tuj)
                                <option value="{{ $tuj->id_tujuan }}" {{ old('id_tujuan') == $tuj->id_tujuan ? 'selected' : '' }}>{{ $tuj->nama_tujuan }}</option>
                            @endforeach
                        </select>
                        @error('id_tujuan')
                        <div class="invalid-feedback">
