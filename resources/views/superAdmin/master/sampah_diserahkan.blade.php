                ...
                <div class="table-responsive">
                    <table id="sampah-diserahkan-table" class="table table-striped table-bordered w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center">{{ $sampahDiserahkans->firstItem() + $index }}</td>
                            ...
                            @empty
                            <tr>
                                <td colspan="10" class="text-center">Tidak ada data sampah diserahkan</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
...
$(document).ready(function() {
    ...
    var table = $('#sampah-diserahkan-table').DataTable({
        responsive: true,
        pageLength: 10,
        ...
        columnDefs: [
            { targets: 9, visible: false } // Hide Alasan Edit column by default
        ]
    });
    ...
    var alasanEditVisible = localStorage.getItem('showAlasanEditDiserahkan') === 'true';
    ...
    $('#toggleAlasanEdit').on('click', function() {
        ...
        localStorage.setItem('showAlasanEditDiserahkan', alasanEditVisible);
        updateToggleButton();
    });
});
</script>
