    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form action="{{ route('superadmin.master.jenis.update', $jenis->id_jenis) }}" method="POST" id="jenisForm">
                @csrf
                @method('PUT')
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <select class="form-select @error('kategori_jenis') is-invalid @enderror" id="kategori_jenis" name="kategori_jenis" required>
                            ...
                            <option value="organik" {{ old('kategori_jenis', $jenis->kategori_jenis) == 'organik' ? 'selected' : '' }}>Organik</option>
                            <option value="anorganik" {{ old('kategori_jenis', $jenis->kategori_jenis) == 'anorganik' ? 'selected' : '' }}>Anorganik</option>
                            <option value="residu" {{ old('kategori_jenis', $jenis->kategori_jenis) == 'residu' ? 'selected' : '' }}>Residu</option>
                        </select>
