...
<div class="content-area-table">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="mb-3">
                <a href="{{ route('superadmin.master.sampah-terkelola.create') }}" class="btn btn-primary text-white">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="d-inline-flex gap-1">
                                    <a href="{{ route('superadmin.master.sampah-terkelola.show', $sampah->id) }}"
                                ...
                                <form id="delete-form-{{ $sampah->id }}"
                                      action="{{ route('superadmin.master.sampah-terkelola.destroy', $sampah->id) }}"
...
$(document).ready(function () {
    let table = $('#sampahTerkelolaTable').DataTable({
        ...
        info: false,
        columnDefs: [
            { orderable: false, targets: [1, 7] } // Foto dan Aksi tidak bisa di-sort
        ]
    });
});
