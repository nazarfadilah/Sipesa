    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div style="background-color: #1E3F8C" class="p-4 rounded-top">
                <h4 class="text-white mb-0">Master Data > Tambah Instansi</h4>
            </div>
            <div class="bg-white p-4 rounded-bottom shadow">
                <form action="{{ route('superadmin.master.instansi.store') }}" method="POST" id="instansiForm">
                    @csrf
...
$(document).ready(function() {
    ...
    $('#instansiForm').on('submit', function(e) {
        ...
        Swal.fire({
            title: 'Konfirmasi',
            text: 'Apakah Anda yakin ingin menyimpan data instansi ini?',
            icon: 'question',
