...
@section('title', 'Edit Data Sampah Terkelola')
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="bg-white p-4 rounded-bottom shadow">
                ...
                <form action="{{ route('petugas.update-sampah-terkelola', $sampah->id) }}" method="POST" enctype="multipart/form-data" id="formEdit">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group" style="margin-top: 30px;">
                        <a href="{{ route('petugas.sampah-terkelola') }}" class="btn btn-secondary">
...
<script>
    function confirmEdit() {
        ...
        Swal.fire({
            ...
            text: 'Apakah Anda yakin ingin menyimpan perubahan data sampah terkelola ini?',
            icon: 'question',
    ...
    // Filter Jenis Form berdasarkan Kategori
    function setupKategoriListener() {
        ...
        kategoriSelect.addEventListener('change', function() {
            ...
            jenisOptions.forEach(option => {
                ...
                } else if (option.dataset.kategori && option.dataset.kategori.toLowerCase() === selectedKategori) {
                    option.style.display = 'block';
                } else {
            ...
            // Jika jenis sudah dipilih tapi tidak sesuai kategori, reset
            if (jenisSelect.value) {
                const selectedOption = jenisSelect.options[jenisSelect.selectedIndex];
                const optionKategori = selectedOption.dataset.kategori ? selectedOption.dataset.kategori.toLowerCase() : '';
