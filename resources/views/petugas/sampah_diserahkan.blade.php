    ...
    <div class="row mb-4">
        <div class="col-md-10 mx-auto">
            <div class="bg-primary text-white p-3 rounded mb-4">
                <h3 class="mb-0">Lihat Riwayat Inputan - Sampah Diserahkan</h3>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-inline-flex gap-1">
                                            ...
                                            <a href="{{ route('petugas.edit-sampah-diserahkan', $sampah->id) }}"
...
$(document).ready(function () {
    let table = $('#sampahDiserahkanTable').DataTable({
        ...
        info: true,
        columnDefs: [
            { orderable: false, targets: [1, 7, 8] } // Foto, Alasan Edit, dan Aksi tidak bisa di-sort
        ]
    });
});
</script>
