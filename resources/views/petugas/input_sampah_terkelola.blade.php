...
<div class="container-fluid px-4 py-4">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="row" id="berat-form-wrapper">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="jumlah_berat" class="form-label">Berat (Kg) <span class="text-danger">*</span></label>
                        <input type="number" id="jumlah_berat" name="jumlah_berat" class="form-control" step="0.01" min="0" placeholder="0.00">
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="foto_kelola" name="foto_kelola" accept="image/*">
                                <label class="custom-file-label" for="foto_kelola">Choose file</label>
                            </div>
                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // ✅ Enable/Disable Jenis berdasarkan Kategori
        ...
        kategoriSelect.addEventListener('change', function() {
            ...
            if (selectedKategori === '' || !selectedKategori) {
                // Disable dan reset jenis select
